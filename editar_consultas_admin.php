...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['editar_consultas'])) {
    ...
    $query = "UPDATE consultas SET data_consulta = $1, hora_consulta = $2 WHERE id_consulta = $3 AND id = $4";
    $result = pg_query_params($conn, $query, array($data_consulta, $hora_consulta, $id_consulta, $_SESSION['id']));
